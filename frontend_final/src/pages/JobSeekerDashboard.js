...
const JobSeekerDashboard = () => {
  ...
  const {
    ...
    defaultValues: {
      currentIndustry:
        user?.careerProfile?.currentIndustry || 'IT Services & Consulting',
      department:
        user?.careerProfile?.department || 'Engineering - Software & QA',
      ...
      desiredEmploymentType:
        user?.careerProfile?.desiredEmploymentType || 'Full Time',
  ...
  const {
    ...
    defaultValues: {
      ...
      workPermitOtherCountries:
        user?.personalDetails?.workPermitOtherCountries || [],
  ...
  const onEmploymentSubmit = async (data) => {
    const payload = {
      ...
      joiningDate: `${data.joiningYear}-${String(data.joiningMonth).padStart(
        2,
        '0'
      )}-01`,
  ...
  const onPersonalDetailsSubmit = async (data) => {
    try {
      ...
      enqueueSnackbar('Failed to update personal details', {
        variant: 'error',
      });
    }
  };
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Grid item xs={12} md={2}>
          ...
          >
            <CardContent sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
              ...
              >
                <Work sx={{ fontSize: 30, color: 'black' }} />
              </Box>
              <Box>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <CardContent sx={{ display: 'flex', alignItems: 'center', p: 2 }}>
              ...
              >
                <Bookmark sx={{ fontSize: 30, color: 'black' }} />
              </Box>
              <Box>
                <Typography variant="h4" fontWeight="bold">
                  {savedJobs.length}
                </Typography>
                <Typography sx={{ opacity: 0.9 }}>Saved Jobs</Typography>
              </Box>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Box>
          ...
          {applications.length === 0 ? (
            ...
            <Card
              sx={{
                borderRadius: 3,
                boxShadow: '0 6px 18px rgba(100, 130, 184, 0.75)',
                textAlign: 'center',
                py: 3,
                px: 2,
              }}
              ...
              <Card sx={{ p: 2.5, borderRadius: 3, boxShadow: 3 }}>
                    ...
                    <>
                      ...
                      {skillsList.map((sk) => (
                        ...
                        >
                          ...
                          <Grid item xs={3}>
                            <Typography variant="body2">
                              {sk.expYears} Year{sk.expYears !== 1 ? 's' : ''}{' '}
                              {sk.expMonths} Month
                              {sk.expMonths !== 1 ? 's' : ''}
                            </Typography>
                          </Grid>
                  ...
                  <Grid container spacing={2} sx={{ mt: 1 }}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <Typography variant="body2">
                        ...
                        {careerProfile.desiredJobType?.join(', ') ||
                          'Not specified'}
                      </Typography>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                    ...
                    <Grid item xs={12}>
                      <Typography variant="body2">
                        ...
                        {careerProfile.preferredWorkLocations?.join(', ') ||
                          'Not specified'}
                      </Typography>
                    </Grid>
                  </Grid>
                ...
                >
                  ...
                  <Grid container spacing={2} sx={{ mt: 1 }}>
                    ...
                    {personalDetails.workPermitOtherCountries &&
                      personalDetails.workPermitOtherCountries.length > 0 && (
                        <Grid item xs={12} sm={6}>
                          <Typography variant="body2">
                    ...
                    {(personalDetails.singleParent ||
                      personalDetails.workingMother ||
                      personalDetails.retired ||
                      personalDetails.lgbtq) && (
                      <Grid item xs={12}>
                        <Typography variant="body2">
      ...
      >
        <form onSubmit={handleCareerProfileSubmit(onCareerProfileSubmit)}>
          <DialogTitle sx={{ fontWeight: 600 }}>Career Profile</DialogTitle>
          ...
          <DialogContent dividers sx={{ p: 3 }}>
            ...
            <FormControl
              fullWidth
              margin="dense"
              error={!!careerProfileErrors.desiredJobType}
            >
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    careerProfileErrors.desiredEmploymentType?.message
                  }
                >
            ...
            <FormControl
              fullWidth
              margin="dense"
              error={!!careerProfileErrors.preferredWorkLocations}
            >
                  ...
                  >
                    {workLocations.map((location) => (
                      <MenuItem key={location} value={location}>
                        <Checkbox
                          checked={field.value.indexOf(location) > -1}
                        />
                        {location}
                      </MenuItem>
                    ))}
      ...
      >
        <form onSubmit={handlePersonalDetailsSubmit(onPersonalDetailsSubmit)}>
          <DialogTitle sx={{ fontWeight: 600 }}>Personal Details</DialogTitle>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        error={
                          !!personalDetailsErrors.languages?.[index]?.language
                        }
                      >
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        error={
                          !!personalDetailsErrors.languages?.[index]
                            ?.proficiency
                        }
                      >
